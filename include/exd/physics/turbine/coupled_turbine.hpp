...
namespace fdm3 = exd::physics::fluid::fdm3;
...
struct CoupledTurbineConfig
{
    ...
    mechanics::CurveMomentConfig generator; // opposing T(ω); empty = free spin
    ...
    io::IFieldWriter* field_writer = nullptr;         // non-owning; stamped per policy
