...
// exd::physics::fluid::fdm.  It reuses the 2D time-integration, advection and
...
// Reused 2D solver enums (see exd::physics::fluid::fdm::fdm_config.hpp).
using exd::physics::fluid::fdm::TimeIntegration;
using exd::physics::fluid::fdm::AdvectionScheme;
