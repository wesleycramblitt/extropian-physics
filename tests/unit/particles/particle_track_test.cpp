...
using namespace exd::physics::particles;
...
struct EmptyFlow : exd::physics::coupling::IVectorField3D
{
...
TEST_CASE("Particles: structured-grid channel drift smoke")
{
    ...
    exd::physics::coupling::StructuredVectorGrid grid;
    grid.origin = {0, 0, 0};
    ...
    auto channel = exd::physics::coupling::make_vector_grid_field(grid);
