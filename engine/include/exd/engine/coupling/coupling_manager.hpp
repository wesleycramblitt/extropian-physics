...
public:
    ...
    bool register_domain(const DomainHandle& domain, exd::engine::core::ModelStatus& status);
    ...
    bool add_link(const CouplingLink& link, exd::engine::core::ModelStatus& status);
    ...
    int exchange(double t, exd::engine::core::ModelStatus& status);
    ...
    int exchange_implicit(double t, double tolerance, exd::engine::core::ModelStatus& status);
...
private:
    ...
    bool gather_exchange(LinkRuntime& rt, exd::engine::core::ModelStatus& status);
    bool apply_exchange(LinkRuntime& rt, exd::engine::core::ModelStatus& status);
...
public:
    ...
    bool add_domain(const CoupledDomainSpec& spec, exd::engine::core::ModelStatus& status);
    bool add_link(const CouplingLink& link, exd::engine::core::ModelStatus& status);
    ...
    RunReport run(double time_horizon, exd::engine::core::ModelStatus& status);
