...
public:
    ...
    virtual double pressure(double rho, double T, exd::engine::core::ModelStatus& status) const = 0;
    /// Temperature from pressure and density (K).
    virtual double temperature(double p, double rho, exd::engine::core::ModelStatus& status) const = 0;
    ...
    virtual double density(double p, double T, exd::engine::core::ModelStatus& status) const = 0;
    ...
    virtual double specific_entropy(double p, double T,
                                    exd::engine::core::ModelStatus& status) const = 0;
    /// Specific internal energy e (J/kg), reference at 0 K.
    virtual double internal_energy(double rho, double T, exd::engine::core::ModelStatus& status) const = 0;
    /// Specific enthalpy h (J/kg), reference at 0 K.
    virtual double enthalpy(double rho, double T, exd::engine::core::ModelStatus& status) const = 0;
