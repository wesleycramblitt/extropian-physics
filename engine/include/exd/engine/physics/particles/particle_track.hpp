...
//
// with the shared exd::engine::numerics::integrate_step() integrator over one big flat state
...
namespace exd::engine::physics::particles {
...
struct ParticleConfig
{
    ...
    const exd::engine::coupling::IVectorField3D* flow_channel = nullptr; // optional background v_f (m/s)
