...
using namespace exd::engine::physics::fluid::lumped;
using exd::engine::core::ModelStatus;
using exd::engine::numerics::IntegratorConfig;
using exd::engine::numerics::IntegrationMethod;
...
{
    return exd::engine::physics::thermo::make_ideal_gas(exd::engine::physics::thermo::IdealGasConfig{});
}
