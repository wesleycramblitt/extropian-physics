...
#include <exd/engine/physics/fluid/turbomachinery/operating_map.hpp>
...
using exd::engine::physics::fluid::turbomachinery::MapSample;
using exd::engine::physics::fluid::turbomachinery::MapSweepConfig;
using exd::engine::physics::fluid::turbomachinery::OperatingMap;
using exd::engine::physics::fluid::turbomachinery::StageConfig;
using exd::engine::physics::fluid::turbomachinery::StageInlet;
using exd::engine::physics::fluid::turbomachinery::StageStackConfig;
using exd::engine::physics::fluid::turbomachinery::solve_operating_map;
using exd::engine::physics::fluid::turbomachinery::sample_operating_map;
...
TEST_CASE("operating_map: map echoes direct solves at grid nodes")
{
    ...
    auto direct =
        exd::engine::physics::fluid::turbomachinery::solve_stage_stack(
