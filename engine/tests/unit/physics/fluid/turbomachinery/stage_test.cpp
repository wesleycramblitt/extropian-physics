...
using exd::engine::physics::fluid::turbomachinery::StageConfig;
using exd::engine::physics::fluid::turbomachinery::StageGeometryConfig;
using exd::engine::physics::fluid::turbomachinery::StageInlet;
using exd::engine::physics::fluid::turbomachinery::StageResult;
using exd::engine::physics::fluid::turbomachinery::solve_stage;
using exd::engine::physics::fluid::turbomachinery::validate_stage_config;

namespace
{

std::unique_ptr<exd::engine::physics::thermo::IEos> make_air()
{
    return exd::engine::physics::thermo::make_ideal_gas({287.05, 1.4});
}
...
InletState inlet_closure(const exd::engine::physics::thermo::IEos& eos,
...
TEST_CASE("stage: geometry-emergent sense reversal (full closure)")
{
    ...
    exd::engine::physics::fluid::turbomachinery::StageStackConfig stack;
    stack.stages = {stage_a, stage_b};
    ModelStatus stack_status;
    auto stack_result =
        exd::engine::physics::fluid::turbomachinery::solve_stage_stack(stack, inlet, omega, mdot, *eos, stack_status);
    ...
    exd::engine::physics::fluid::turbomachinery::StageStackConfig stack_r;
    stack_r.stages = {stage_a_eta1, stage_b_eta1};
    ModelStatus reversible_status;
    auto reversible =
        exd::engine::physics::fluid::turbomachinery::solve_stage_stack(stack_r, inlet, omega, mdot, *eos, reversible_status);
