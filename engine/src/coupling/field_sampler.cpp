...
{
public:
    FdmFieldAdapter(const exd::engine::physics::fluid::fdm::FDMFieldData& field,
...
private:
    exd::engine::physics::fluid::fdm::FDMFieldData field_;
    double rho_;
    double mu_;
    double p_ref_;
};
...
{
public:
    Fdm3FieldAdapter(const exd::engine::physics::fluid::fdm3::FDM3Solver& solver)
        : field_(solver.field()),
...
private:
    exd::engine::physics::fluid::fdm3::FDM3FieldData field_;
    double rho_;
    double mu_;
};
                                       ...
                                       double p_ref)
{
    ...
    exd::engine::physics::fluid::forces::SurfaceFlow flow;
