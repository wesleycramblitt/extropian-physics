...
bool CouplingManager::add_link(const CouplingLink& link, exd::engine::core::ModelStatus& status)
{
    status = exd::engine::core::ModelStatus{};
...
int CouplingManager::exchange(double t, exd::engine::core::ModelStatus& status)
{
    status = exd::engine::core::ModelStatus{};
...
bool CoupledSimulation::add_link(const CouplingLink& link, exd::engine::core::ModelStatus& status)
{
    status = exd::engine::core::ModelStatus{};
                                                    ...
                                                    exd::engine::core::ModelStatus& status)
{
    ...
    for (size_t m = 0; m < macro_plan; ++m)
    {
        ...
        exd::engine::core::ModelStatus exchange_status;
        int executed = 0;
        if (config_.implicit)
        {
